...
export default function SummaryOrder() {
  const [cartItems, setCartItems] = useState<CartItem[]>([
    { id: "1", name: "Bakso Sapi", price: 25000, quantity: 2 },
    { id: "2", name: "Es Teh", price: 5000, quantity: 1 },
  ])
    ...
    <div className="h-full flex flex-col bg-card rounded-lg border border-border overflow-hidden">
      ...
      <div className="border-t border-border p-3 space-y-3 flex-shrink-0">
        ...
        <div className="grid grid-cols-2 gap-2 pt-2">
          ...
          <Button className="bg-primary hover:bg-primary/90" disabled={cartItems.length === 0}>
            Checkout
          </Button>
        </div>
      </div>
